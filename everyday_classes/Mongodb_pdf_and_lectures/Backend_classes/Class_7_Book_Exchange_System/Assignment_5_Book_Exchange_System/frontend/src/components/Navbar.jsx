          ...
          {isAuthenticated ? (
            <>
              ...
              <div className="flex items-center gap-2 rounded-full border border-ink-200 dark:border-paper-400/20 py-1 pl-1 pr-3">
                <NavLink to="/profile" className="flex items-center gap-2" aria-label="View your profile">
                  <span className="flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-full bg-moss-50 dark:bg-moss-500/10 font-display text-sm font-semibold text-moss-600 dark:text-brass-400">
          ...
          <nav className="flex flex-col gap-1" aria-label="Mobile">
            ...
            {isAuthenticated ? (
              <>
                ...
                <NavLink to="/profile" onClick={() => setOpen(false)} className="rounded-lg px-3 py-3 text-sm font-semibold text-ink-600 dark:text-paper-200">
                  Profile
                </NavLink>
