...
// Deletes a previously uploaded cover image from disk.
// Safe to call even if the file is missing or the book had no image.
const deleteImageFile = (coverImage) => {
    ...
    fs.unlink(filePath, (err) => {
        if (err && err.code !== "ENOENT") {
            console.error("Couldn't delete image file:", err.message);
        }
    });
